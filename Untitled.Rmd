...
In this dataset, we are dealing with a dam, which is being represented as a point location on a hydrologic network. A template for this kind of feature is available here: https://github.com/internetofwater/docs.geoconnex.us/wiki/hydrologic-location-template 
